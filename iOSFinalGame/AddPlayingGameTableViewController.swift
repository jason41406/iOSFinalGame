//
//  AddPlayingGameTableViewController.swift
//  iOSFinalGame
//
...
class AddPlayingGameTableViewController: UITableViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    @IBOutlet weak var scoreSegmented: UISegmentedControl!
    @IBAction func done(_ sender: Any) {
        if nameTextField.text?.characters.count == 0 || typeTextField.text?.characters.count == 0{
        ...
        let dic = ["name":nameTextField.text!,
                   ...
                   "photo":"\(number)",
                   "scoreSegmented":"\(scoreSegmented.selectedSegmentIndex + 1)星"] as [String : String]
