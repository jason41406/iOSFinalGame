//
//  PlayingGameTableViewController.swift
//  iOSFinalGame
//
...
class PlayingGameTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "playingGameCell", for: indexPath) as!PlayingGameTableViewCell
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "showPlayingGameDetail" {
            let indexPath = self.tableView.indexPathForSelectedRow
            let dic:[String:String]
            dic = games[indexPath!.row]
            let controller = segue.destination as! PlayingGameViewController
